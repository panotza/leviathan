...
3 – 4 | fan speed [rpm]
5 – 6 | pump speed [rpm]
7 – 14 | footer 1 (appears to be constant for a given Kraken model)
15 – 16 | footer 2 (not constant)

Footer 1 appears to have the following valid values:

Value | Kraken model
------|-------------
`0x00 0x00 0x00 0xff 0x02 0x00 0x01 0x08` | X42
`0x00 0x00 0x00 0x78 0x02 0x00 0x01 0x08` | X62
