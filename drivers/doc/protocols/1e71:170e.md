...
Byte | Meaning
-----|--------
0 | `0x04` header #1 (constant)
1 | liquid temperature [°C]
2 | unknown value #1 (not constant, fluctuates between 1 and 9)
3 – 4 | fan speed [rpm]
5 – 6 | pump speed [rpm]
7 – 10 | unknown value #2 (not constant, last byte changes)
11 – 14 | `0x02 0x00 0x01 0x08` footer #1 (appears to be constant)
15 – 16 | unknown value #3 (not constant)
